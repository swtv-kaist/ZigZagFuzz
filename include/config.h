...
#define HAVOC_ARGV_BLK_SMALL 16
#define HAVOC_ARGV_BLK_MEDIUM 32
#define HAVOC_ARGV_BLK_LARGE 64
#define HAVOC_ARGV_BLK_XL 128

#define MAX_ARGV_WORDS 128
...
#define ARGV_MUT_TIMEOUT (30 * 60 * 1000)
#define FILE_MUT_TIMEOUT ARGV_MUT_TIMEOUT

#define EXPLORATORY_TIMEOUT 60 * 60 * 1000

#define FAIR_CMD_MUT_TIME 1
#define FAIR_FILE_MUT_TIME 5

#define NUM_ARGV_CLUSTERS 20
#define NUM_SEL_IN_ARGV_CLUSTER 2

#define NUM_FILE_CLUSTERS 800
#define NUM_SEL_IN_FILE_CLUSTER 2

#define NUM_SEL_RATIO 1

#define REMOVE_ZERO_ARGVS_RATIO 0.9
#define NUM_SEL_ZERO_ARGVS 40

#define TRIM_LIMIT 32

#define DEFAULT_ARGV_RANDOM_MUT_PROB 50
